...
const Widgets = Me.imports.src.services.dashWidgets;
const ConfigParser = Me.imports.src.services.dashConfigParser;
const {PanelButton} = Me.imports.src.ui.panelButton;
