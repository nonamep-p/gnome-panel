...
} = Me.imports.src.preferences.widgets;

const {wsNamesGroup} = Me.imports.src.preferences.workspaces;
...
class DashBoardPage extends SubPage {
    _init(settings) {
        ...
        const readConfigRow = new Adw.ActionRow({title: _('Read Config'), subtitle: '~/.local/share/gnome-shell/extensions/nonamesPanel@noname/config/dashboard.json'});
