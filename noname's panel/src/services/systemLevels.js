...
const {St, Gio, Clutter, GObject, GLib, UPowerGlib: UPower} = imports.gi;
...
class LevelsBox extends St.BoxLayout {
    ...
    startTimeout() {
        this.timeout = GLib.timeout_add_seconds(GLib.PRIORITY_DEFAULT, 1, this.updateLevels.bind(this));
    }
